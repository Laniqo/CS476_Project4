...
INSERT INTO user(user_id, username, email, pw_hash) VALUES ('?', 'user7', 'user7@sample.com', 'pbkdf2:sha256:50000$FCV2OQCj$e4c87d8752b5b9ce1b5d97aa70dbd4f9cd16d0caaefcf7d3886a928229388d62' );


INSERT INTO message(message_id, author_id, text, pub_date) VALUES
(1,'1502ebfe-433f-4756-ba42-06ca1e896c39', 'user1 here', 1518739155),
(2,'ce701bfb-ca81-4227-bb97-fdeed2ac4376', 'user 2! post  up!', 1518739190),
(3,'47e8d685-ccee-4c7d-8029-9a11d5cc9e55', 'whack!', 1518739978),
(4,'e6607a8e-70a3-4a89-bcb9-b84a4e915499', 'used up so much time on this!!', 1518741365),
(5,'90417063-b425-4f10-b161-28234534c8b4', 'I could be doing better things and getting paid!', 1518741369);
